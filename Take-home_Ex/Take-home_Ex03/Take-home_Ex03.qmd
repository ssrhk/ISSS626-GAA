...
Then we will use **cbind** (since there is no unique identifier) to join the newly created dataframe of residuals with our point feature data.frame, tanzania_cleaned, to plot the distribution.
...
Clusters of similar residual values are visible in several regions. For instance, areas in the eastern parts of Tanzania show concentrations of positive residuals (green dots), whereas some central and northern regions display clusters of negative residuals (red dots). These clusters suggest spatial patterns in the model's performance, indicating that it may overestimate or underestimate values systematically in specific areas.
...
FinancialEducation_YesNo_Ratio_SE <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "FinancialEducation_YesNo_Ratio_SE",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
...
FinancialEducation_YesNo_Ratio_TV <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "FinancialEducation_YesNo_Ratio_TV",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
ComfortableBank_YesNo_Ratio_SE <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "ComfortableBank_YesNo_Ratio_SE",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
ComfortableBank_YesNo_Ratio_TV <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "ComfortableBank_YesNo_Ratio_TV",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
Used_CreditCard_SE <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "Used_CreditCard_SE",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
Used_CreditCard_TV <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "Used_CreditCard_TV",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
BadPhoneConnection_SE <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "BadPhoneConnection_SE",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
BadPhoneConnection_TV <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "BadPhoneConnection_TV",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
Do_Not_Think_They_Care_SE <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "Do_Not_Think_They_Care_SE",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
...
Do_Not_Think_They_Care_TV <- tm_shape(tanzbounds)+
  tm_polygons(alpha = 0.1) +
tm_shape(gwr_sf_adaptive) +  
  tm_dots(col = "Do_Not_Think_They_Care_TV",
          border.col = "gray60",
          border.lwd = 1) +
  tm_view(set.zoom.limits = c(11,14)) +
  tm_layout(title.size = 0.5)
