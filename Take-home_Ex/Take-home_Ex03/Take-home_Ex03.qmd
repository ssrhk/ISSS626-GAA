...
## 6.3 Dependent Variable Implications
...
```{r}
vif_values <- ols_vif_tol(tanzania.mlr)
high_vif_values <- vif_values[vif_values$VIF > 10, ]
high_vif_values
```
...
### 9.2.2 Visualizing coefficient estimates
