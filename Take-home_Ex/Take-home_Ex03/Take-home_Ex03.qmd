...
|                                                                                                                                                                      |                                                                                    |                                                                                                                                                              |
|                                                                                                                                                                      |                                                                                    | Encoded as financialaccess_count( checks if respondent have access to at least one financial product (set as 1 if they have access to any, 0 if they don’t). |
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-   $DistrictCount​_i$ = Number of individuals of that particular district i

```{r}
tanzania_cleaned <- tanzania_cleaned %>%
  mutate(FPAI = (financialaccess_count / district_count))
```
...
The initial model has an adjusted R-squared value of 0.5865, meaning that approximately 59% of the variation in the Financial Participation and Access Index (FPAI) is explained by these predictors.
...
```{r}
#| echo: False
final_tanzania.mlr<- lm(FPAI ~ FinancialEducation_YesNo_Ratio + Total_GroupBelong + NoEdu_SomeEdu + 
