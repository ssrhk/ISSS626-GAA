...
tanzania.mlr <- lm(FPAI ~ Urban + Male_Female_Ratio + Registered_YesNo_Ratio + ComfortableBank_YesNo_Ratio + 
  FinancialEducation_YesNo_Ratio + PayingBack_YesNo_Ratio + NoEdu_SomeEdu + MobilePhone + 
  ...
  MoneyforBusiness_SaleOfAssets + MoneyforBusiness_SavingsOrSalary + TriedButNot + 
  NoTime + NoMoney + TooComplicated + NoBenefit + BusinessTooSmall + NoPayment + 
  DontKnowHow + RegistrationInProcess + Formal_sector_salaried + Informal_sector_salaried + 
  ...
  BorrowedThroughMM + SoldLivestock + WorkedMore + Others_CouldntMeetNeeds + Old_Savings + 
  Old_ChildrenWillTakeCareOfMe + Old_MoneyFromFriendsRelatives + Old_LandProperty + 
  ...
  Used_QR_Code + Used_POS + Used_LipaNamba + Used_AZAMPay + Basic_TASAF_Cash_Transfer + 
  Additional_Conditional_TASAF_Cash_Transfer + Pension_for_Elders + Others_Assistance + 
  Payment_Was_Late + Gave_Money_To_Official + Money_Didnt_Come + Received_Less_Money + 
  ...
  Households_Contents_Insurance + Private_Health_Insurance + National_Health_Insurance + 
  Community_Health_Insurance + TIKA_Insurance + Social_Health_Insurance + 
  Personal_Accident_Insurance + Life_Insurance + Loan_Insurance + Building_Insurance + 
  Education_Policy + Funeral_Cover + Agricultural_Insurance + Ushirika_Afya + 
  Motorcycle_Insurance + Livestock_Insurance + Other_Insurance_Products + Agent_Absent + 
  Agent_No_Cash_Float + Agent_Overcharged + Lost_Money + Agent_Requested_PIN + Other_Problems + 
