...
|        |          |           |        |
|--------|----------|-----------|--------|
| Laptop | Internet | 1.0000000 | Laptop |

|                            |                  |           |                            |
|----------------------------|------------------|-----------|----------------------------|
| Farmers_and_fishers_Income | BusinessTooSmall | 0.8078662 | Farmers_and_fishers_Income |

|                                 |                            |           |                                 |
|---------------------------------|----------------------------|-----------|---------------------------------|
| Old_FarmingAgricultureLivestock | Farmers_and_fishers_Income | 0.8149506 | Old_FarmingAgricultureLivestock |

|                          |                        |           |                          |
|--------------------------|------------------------|-----------|--------------------------|
| BorrowedFromFriendFamily | Advice_HouseholdMember | 0.8038739 | BorrowedFromFriendFamily |

|                         |                        |           |                         |
|-------------------------|------------------------|-----------|-------------------------|
| GotAssistanceFromFamily | Advice_HouseholdMember | 0.8242829 | GotAssistanceFromFamily |

|                     |                        |           |                     |
|---------------------|------------------------|-----------|---------------------|
| Insurance_Good_Idea | Advice_HouseholdMember | 0.8232845 | Insurance_Good_Idea |

|                             |                          |           |                             |
|-----------------------------|--------------------------|-----------|-----------------------------|
| BorrowedFrom_Family_PayBack | BorrowedFromFriendFamily | 0.8943542 | BorrowedFrom_Family_PayBack |

|           |                        |           |           |
|-----------|------------------------|-----------|-----------|
| Used_Cash | Advice_HouseholdMember | 0.8590026 | Used_Cash |

|                     |                          |           |                     |
|---------------------|--------------------------|-----------|---------------------|
| Insurance_Good_Idea | BorrowedFromFriendFamily | 0.8123864 | Insurance_Good_Idea |

|             |             |           |             |
|-------------|-------------|-----------|-------------|
| CutSpending | UsedSavings | 0.8675488 | CutSpending |

|                    |                          |           |                    |
|--------------------|--------------------------|-----------|--------------------|
| ConfidentWithBanks | ConfidentWithMobileMoney | 0.8916325 | ConfidentWithBanks |

|           |                    |           |           |
|-----------|--------------------|-----------|-----------|
| Used_Cash | ConfidentWithBanks | 0.8446089 | Used_Cash |

|                           |                          |           |                           |
|---------------------------|--------------------------|-----------|---------------------------|
| Trust_Insurance_Companies | ConfidentWithMobileMoney | 0.8376665 | Trust_Insurance_Companies |

|                     |                          |           |                     |
|---------------------|--------------------------|-----------|---------------------|
| Insurance_Good_Idea | ConfidentWithMobileMoney | 0.8461074 | Insurance_Good_Idea |

|                           |                         |           |                           |
|---------------------------|-------------------------|-----------|---------------------------|
| Trust_Insurance_Companies | GotAssistanceFromFamily | 0.8133255 | Trust_Insurance_Companies |

|                 |                     |           |                 |
|-----------------|---------------------|-----------|-----------------|
| Network_Failure | Agent_No_Cash_Float | 0.8285897 | Network_Failure |

|                    |                        |           |                    |
|--------------------|------------------------|-----------|--------------------|
| Moneylender_Access | Moneylender_TreatsWell | 0.9259172 | Moneylender_Access |

|                       |                        |           |                       |
|-----------------------|------------------------|-----------|-----------------------|
| Moneylender_InfoClear | Moneylender_TreatsWell | 0.9420714 | Moneylender_InfoClear |

|                      |                        |           |                      |
|----------------------|------------------------|-----------|----------------------|
| Moneylender_NeedsMet | Moneylender_TreatsWell | 0.9779739 | Moneylender_NeedsMet |

|                            |                        |           |                            |
|----------------------------|------------------------|-----------|----------------------------|
| Moneylender_FeesReasonable | Moneylender_TreatsWell | 0.8838490 | Moneylender_FeesReasonable |

|                             |                        |           |                             |
|-----------------------------|------------------------|-----------|-----------------------------|
| Moneylender_CustomerSupport | Moneylender_TreatsWell | 0.9335145 | Moneylender_CustomerSupport |
